                    ...
                    <div class="card-body yellow-bg text-center">
                        <?php 
                            ...
                            foreach ($hotelData as $hotel) {
                                ...
                                if($hotel['verify']=='waite'&& $hotel['id']== $id){
  ?>
                        ...
                        <div class="row "
                            ...
                            <div class="col-md-6" style="margin: 10px 0px;">
                                <a class="btn btn-success" style="width: 30%;" onclick="approve()">อนุมัติ</a>
                            </div>
                            <div class="col-md-6" style="margin: 10px 0px;">
                                <a class="btn btn-danger" style="width: 30%;" onclick="unapprove()">ไม่อนุมัติ</a>
                            </div>
                        </div>
...
<!-- JavaScript เพื่อแสดงหน้าต่างข้อความ (sweet alert) หลังจากการอัปเดตสถานะสำเร็จ -->
