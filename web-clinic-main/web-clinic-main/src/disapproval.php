...
if (!isset($_SESSION['token'])) {
  ...
  curl_setopt_array($curl, array(
    CURLOPT_URL => 'https://backend-application.pcnone.com/booking/list-booking-all',
...
a {
    ...
    color: inherit; /* ให้ลิงก์เป็นสีเดียวกับข้อความ */
}
</style>
...
<body class="t1">
  ...
  <main>
    ...
    <?php include('./plugin/disapproval_order.php');?>
    </section>
  </main>
