        ...
        <div class="col">
            ...
            if (!isset($order_all_data['status'])) {
                ...
                if (!empty($order_all_data)) {
                    $has_wait_data = false; // เริ่มต้นตั้งค่าว่ายังไม่มีข้อมูล "disapproval"
                    // Loop through the data
                    foreach ($order_all_data as $order) {
                        if ($order['state'] === "disapproval") {
                            $has_wait_data = true;
...
if (isset($_POST['submit1'])) {
    ...
    echo '<script>window.location.href = "disapproval.php";</script>';
